...
export type MdxFrontmatterFilterInput = {
  ...
  legacyPath?: Maybe<StringQueryOperatorInput>,
};
...
export type BlogIndexQuery = { allMdx: (
    ...
    & { edges: Array<{ node: (
        Pick<Mdx, 'id'>
        & { frontmatter: Maybe<Pick<MdxFrontmatter, 'title'>>, fields: Maybe<Pick<MdxFields, 'slug'>> }
      ) }> }
  ) };
...
export type BlogPostQuery = { mdx: Maybe<(
    Pick<Mdx, 'body'>
    & { frontmatter: Maybe<(
      Pick<MdxFrontmatter, 'title' | 'lead'>
      & { day: MdxFrontmatter['date'], month: MdxFrontmatter['date'], year: MdxFrontmatter['date'] }
    )> }
  )> };
